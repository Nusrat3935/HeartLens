...
# Streamlit UI
st.image("https://github.com/Nusrat3935/HeartLens/blob/main/heart.jpg?raw=true", width=700)
...
# Load dataset
data = pd.read_csv(r"https://raw.githubusercontent.com/Nusrat3935/Dataset/refs/heads/main/heart.csv")
